 let speechOutput;
 let reprompt;
 let welcomeOutput = "Welcome to Word Explorer, you can ask me to \
 ...
 const handlers = {
     ...
     'GetWord': function () {
         ...
         //Your custom intent handling goes here
         speechOutput = "This is a place holder response for the intent named GetWord. This intent has no slots. Anything else?";
         this.emit(":ask", speechOutput, speechOutput);
     },
     'SpellingIntent': function () {
         ...
         //Your custom intent handling goes here
         speechOutput = "This is a place holder response for the intent named SpellingIntent. This intent has one slot, which is word. Anything else?";
         this.emit(":ask", speechOutput, speechOutput);
     },
